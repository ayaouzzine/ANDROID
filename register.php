...
$sqlCheckUname = "SELECT * FROM users WHERE username LIKE '$username'";
...
$sql_register = "INSERT INTO users(username,email,password,phone,gender) VALUES ('$username','$email','$password','$mobile','$gender')";
